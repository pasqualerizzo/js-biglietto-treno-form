...
function calcolaPrezzo(event) {
  ...
  let fasciaEta = document.getElementById("select").value;
  let prezzo = km * 0.21; // Prezzo base al km

  if (fasciaEta === "opzione1") {
    prezzo -= prezzo * 0.2; // Sconto del 20% per i minorenni
  } else if (fasciaEta === "opzione3") {
    prezzo -= prezzo * 0.4; // Sconto del 40% per gli over 65
  }
